...
$document->addStyleSheet(JURI::base().'modules/mod_jshopping_products_itb/style.css');
...
<div class="123 312 rand_products_wfl_<?php echo $suff; ?>" id="rand_products_wfl_<?php echo $module->id;?>">
        ...
        <div class="jspw_<?php echo $ribbon_behavior; ?>" >
			...
			<div class="jspw_prod" style="<?php echo $styles2;?>">
				<div class="jspw_prodwrap">
					<div class="jspw_imgwrap" style="background-image: url(<?php echo $imgSrc; ?>);">
