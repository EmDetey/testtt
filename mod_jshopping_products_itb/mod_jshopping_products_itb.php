<?php
# $Id: mod_jshopping_products_itb.php
# package mod_jshopping_products_itb
# file mod_jshopping_products_itb.php
# license http://www.gnu.org/licenses/gpl-3.0.html GNU/GPL
	...
	$title_module = $params->get('title_module');
    ...
    switch($product_source){
        ...
        case 'categories'://OK
            ...
            $list=$product->getAllProducts($filters, 'product_ordering',  null, 0, $product_count);
            break;
        case 'id'://OK
            $filters = array();
    ...
    require(JModuleHelper::getLayoutPath('mod_jshopping_products_itb'));
?>
